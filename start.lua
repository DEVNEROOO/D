...
api_id=12082238,
api_hash='ca919cabc96d3b001cd12d7d09970e30',
session_name=bot_id,
token=Token
}
Sudos = {sudoid,5256894970,5256894970}
Sudo_Id = 5256894970
function Bot(msg)  
local idbot = false  
...
u = '*✫︙هلا حبي بيك بمصنع حماية لسورس  الحمايه 👋🏻 ،\n\n✫︙البوت مقدم من قناة »* [. سوࢪس مشاعࢪ ](t.me/T4LT3) \n\n*✫︙يمكنك الان صنع بوت واحد فقط من صانع البوتات\n\n     عليك استخدام اوامر التحكم اسفل وبدء الانشاء🔻\n⎯ ⎯ ⎯ ⎯ ⎯ ⎯ ⎯ ⎯ ⎯ ⎯*\n[✫︙ تحتاج شي مطوࢪ سورس  .](https://t.me/BEEEB5)'
end
...
return bot.sendText(msg.chat_id,msg.id,[[ عدك مشكلة راسل المبرمج @BEEEB5*
--
